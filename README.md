...
**Control Ableton Live using natural language via AI assistants like Claude or VS Code (Anitgravity, Cusrsor, Devin etc). This project provides a robust Model Context Protocol (MCP) server that translates natural language commands into precise actions within your Ableton Live session.**
