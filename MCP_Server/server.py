    ...
    if _ableton_connection is not None:
        try:
            ...
            try:
                ...
                logger.warning("Error during stale connection cleanup")
            _ableton_connection = None
            _invalidate_external_plugin_cache()
...
def manage_clip_automation(
    ...
    try:
        ...
        if action == "add_point":
            return f"Added automation point: {parameter_name} = {value} at beat {time_in_beats} on clip {clip_index}, track {track_index}"
